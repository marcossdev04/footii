...
export function Step3({ onStepChange, betAmount, selectedCountry }: Props) {
  ...
  return (
    <div className="flex md:flex-row flex-col gap-2">
      ...
      <div className="flex text-sm mt-8 md:text-base font-mono flex-col gap-2 md:gap-5 w-full md:w-1/2 border border-t-4  border-x-zinc-700 rounded-lg border-t-emerald-500 border-b-zinc-700 px-6 py-6 ">
        <div className="">
